...
const Sparkle = ({ x, y, size = 8, delay = 0 }) => {
    ...
    return (
        <Animated.View style={[staticStyles.sparkle, { left: x, top: y, opacity }]}>
...
const BackgroundHeart3D = ({ id, x, y, size = 30, rotation = 0, opacity = 0.85 }) => {
    const gradientId = id || `heart3d-${Math.round(size)}-${Math.round(x)}`;
    return (
        // Position, opacity, and rotation are instance-specific decorative values.
        <View
            style={[
                staticStyles.backgroundHeart,
                {
                    left: x,
                    top: y,
                    opacity: opacity,
...
const TitleSparkleLeft = () => (
    <Svg width={14} height={14} viewBox="0 0 24 24" fill="none" style={staticStyles.titleSparkleLeft}>
        <Path
            d="M16 8L8 4"
            stroke="#FF8FAB"
            strokeWidth={3}
...
const TitleSparkleRight = () => (
    <Svg width={14} height={14} viewBox="0 0 24 24" fill="none" style={staticStyles.titleSparkleRight}>
        <Path
            d="M8 8L16 4"
            stroke="#FF8FAB"
            strokeWidth={3}
...
const NicknameScreen = ({ onComplete }) => {
    ...
    const styles = useMemo(() => createStyles(width, height, insets.bottom), [width, height, insets.bottom]);
    ...
    }, [isCompactHeight, keyboardCardTranslateY, keyboardMascotScale, keyboardMascotTranslateY]);
        ...
        <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
            <View style={styles.root}>
                ...
                >
                    ...
                    <BackgroundHeart3D id="heart-1" x={width * 0.11} y={height * 0.24} size={54} rotation={-16} opacity={0.85} />
                    <BackgroundHeart3D id="heart-2" x={width * 0.78} y={height * 0.31} size={42} rotation={14} opacity={0.72} />

                    {/* Secondary softer hearts */}
                    <BackgroundHeart3D id="heart-3" x={width * 0.13} y={height * 0.34} size={22} rotation={12} opacity={0.45} />
                    <BackgroundHeart3D id="heart-4" x={width * 0.84} y={height * 0.2} size={24} rotation={-10} opacity={0.38} />
                            ...
                            <View style={[styles.titleContainer, keyboardVisible && styles.titleContainerKeyboard]}>
                                <View style={styles.titleRow}>
                                    ...
                                    <Text
                                        ...
                                        style={[styles.title, keyboardVisible && styles.titleKeyboard]}
                                    >
                                        {translateUiText("What's your nickname?")}
                                    </Text>
                                    <TitleSparkleRight />
                                </View>
                                <Text style={[styles.subtitle, keyboardVisible && styles.subtitleKeyboard]}>
                                    {translateUiText("The sweet name your partner will see.")}
                                </Text>
                            </View>
...
const createStyles = (width, height, bottomInset = 0) => {
    const isCompactHeight = height < 760;
    ...
    return StyleSheet.create({
        ...
        subtitle: {
            ...
            color: '#7D748E',
            textAlign: 'center',
            marginTop: isCompactHeight ? 6 : 8,
            fontWeight: fontWeight('600'),
            lineHeight: isCompactHeight ? 20 : 22,
            paddingHorizontal: 16,
        },
        subtitleKeyboard: {
            fontSize: isCompactHeight ? 12 : 14,
            lineHeight: isCompactHeight ? 17 : 19,
            marginTop: isCompactHeight ? 4 : 5,
            paddingHorizontal: 16,
        },
        inputWrapper: {
