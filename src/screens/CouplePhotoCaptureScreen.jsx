...
const styles = StyleSheet.create({
    ...
    backButton: { width: 44, height: 44, borderRadius: 22, backgroundColor: 'rgba(255,255,255,0.9)', alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#F7DDEA', elevation: 0, shadowColor: '#E482AA', shadowOpacity: 0.14, shadowRadius: 9, shadowOffset: { width: 0, height: 4 } },
    ...
    cameraBorder: { flex: 1, borderRadius: 34, padding: 4, elevation: 0, shadowColor: '#D95C9A', shadowOpacity: 0.22, shadowRadius: 18, shadowOffset: { width: 0, height: 10 } },
    ...
    sideControl: { width: 50, height: 50, borderRadius: 20, backgroundColor: 'rgba(255,255,255,0.88)', borderWidth: 1, borderColor: '#F2DDE9', alignItems: 'center', justifyContent: 'center', elevation: 0 },
    shutterOuter: { width: 78, height: 78, borderRadius: 39, backgroundColor: '#FFFFFF', borderWidth: 4, borderColor: '#F07EAA', alignItems: 'center', justifyContent: 'center', elevation: 0 },
    ...
    retakeButton: { flex: 0.72, height: 52, borderRadius: 26, backgroundColor: '#FFFFFF', borderWidth: 1.5, borderColor: '#FFD2E1', alignItems: 'center', justifyContent: 'center', shadowColor: '#D95C9A', shadowOffset: { width: 0, height: 5 }, shadowOpacity: 0.12, shadowRadius: 12, elevation: 0 },
    retakeText: { color: '#D94E86', fontSize: 15, fontFamily: fontFamily.extraBold, fontWeight: fontWeight('800') },
    sendButton: { flex: 1.28, height: 52, borderRadius: 26, shadowColor: '#FF5E97', shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.3, shadowRadius: 16, elevation: 0 },
